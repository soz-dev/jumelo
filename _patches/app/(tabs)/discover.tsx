...
export default function DiscoverScreen() {
  ...
  const [showCelebrateBurst, setShowCelebrateBurst] = useState(false);
        ...
        {loading || !view ? (
          ...
          <View style={styles.centerPad}>
            <View style={styles.celebrateWrap} pointerEvents="none">
              <JumeloLottie name="confetti" size={300} loop={false} />
            </View>
            <Animated.View entering={FadeIn.duration(420)} style={styles.celebrateIcon}>
              <JumeloLottie name="success" size={96} loop={false} />
            </Animated.View>
            <Animated.View entering={FadeInDown.delay(120).duration(380)}>
              <Text style={[styles.celebrateTitle, { color: colors.primaryDark }]}>
                Jumelo formé !
              </Text>
            </Animated.View>
            <Animated.View entering={FadeInDown.delay(200).duration(380)}>
              <Text style={[styles.celebrateBody, { color: colors.inkMuted }]}>
                Toi et {peer.name.split(' ')[0]} êtes officiellement binômes.
              </Text>
            </Animated.View>
            <Animated.View entering={FadeInDown.delay(280).duration(380)} style={{ width: '100%' }}>
              <Pressable
                onPress={() => {
          ...
          <View style={styles.stage}>
            {showCelebrateBurst ? (
              <View style={styles.burstOverlay} pointerEvents="none">
                <JumeloLottie name="confetti" size={320} loop={false} />
              </View>
            ) : null}
            <PeerCard
              peer={peer}
