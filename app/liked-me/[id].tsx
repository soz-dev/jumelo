 ...
 * Redirige vers le flux produit actuel : proposition du jour.
 */
      ...
      <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
        ...
        <View style={styles.body}>
          ...
          <Text style={[styles.copy, { color: colors.inkMuted }]}>
            Chaque jour, une proposition t’attend : tu acceptes ou tu refuses. Si c’est
            mutuel, vous discutez 72 h pour former l’équipe.
          </Text>
          <Button
            label="Ouvrir Du jour"
