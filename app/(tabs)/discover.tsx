...
const RAW_MOCKS: RawMock[] = [
  ...
  // mk-t21→t50 : cas visuels variés (tendances extrêmes, noms longs/courts, compat faible, 0 XP…)
  { id: 'mk-t21', name: 'Street Workout & Calisthenics Élite', universe: 'sports',    subCategoryId: 'muscu',         members: [M.jad, M.basile],    points: 918,  rating: 4.8, sessions: 19, trend:  8, compat: 93 },
  { id: 'mk-t22', name: 'Duo Flûte',                universe: 'music',     subCategoryId: 'flute',         members: [M.camille, M.leonie], points: 880,  rating: 2.8, sessions: 5,  trend: -6, compat: 55 },
  { id: 'mk-t23', name: 'Pilates Matinal',          universe: 'sports',    subCategoryId: 'yoga',          members: [M.talia, M.elisa],   points: 860,  rating: 4.1, sessions: 11, trend:  0, compat: 78 },
  { id: 'mk-t24', name: 'ML & IA Appliquée',        universe: 'education', subCategoryId: 'code',          members: [M.romain, M.youssef],points: 825,  rating: 4.4, sessions: 8,  trend:  5, compat: 69 },
  { id: 'mk-t25', name: 'BD',                       universe: 'hobbies',   subCategoryId: 'dessin',        members: [M.nora, M.lou],      points: 800,  rating: 3.9, sessions: 7,  trend: -2, compat: 62 },
  { id: 'mk-t26', name: 'Overwatch 2 Ranked',       universe: 'gaming',    subCategoryId: 'overwatch',     members: [M.remi, M.paul],     points: 780,  rating: 4.0, sessions: 13, trend:  1, compat: 95 },
  { id: 'mk-t27', name: 'Natation & Open Water',    universe: 'sports',    subCategoryId: 'natation',      members: [M.hugo, M.antoine],  points: 755,  rating: 3.2, sessions: 9,  trend: -4, compat: 38 },
  { id: 'mk-t28', name: 'Violon Classique',         universe: 'music',     subCategoryId: 'violon',        members: [M.fatou, M.mia],     points: 730,  rating: 4.7, sessions: 4,  trend:  3, compat: 88 },
  { id: 'mk-t29', name: 'Philosophie & Débat',      universe: 'education', subCategoryId: 'philo',         members: [M.lucie, M.clara],   points: 710,  rating: 4.3, sessions: 24, trend:  0, compat: 74 },
  { id: 'mk-t30', name: 'Cuisine du Monde',         universe: 'hobbies',   subCategoryId: 'cuisine',       members: [M.salma, M.emilie],  points: 695,  rating: 4.0, sessions: 10, trend: -1, compat: 72 },
  { id: 'mk-t31', name: 'Duo Batterie',             universe: 'music',     subCategoryId: 'batterie',      members: [M.theo, M.axel],     points: 670,  rating: 3.7, sessions: 7,  trend:  2, compat: 80 },
  { id: 'mk-t32', name: 'FIFA Tournoi Local',       universe: 'gaming',    subCategoryId: 'fifa',          members: [M.driss, M.ibra],    points: 648,  rating: 3.5, sessions: 11, trend: -5, compat: 77 },
  { id: 'mk-t33', name: 'Atelier Poterie',          universe: 'hobbies',   subCategoryId: 'poterie',       members: [M.jade, M.chloe],    points: 625,  rating: 4.5, sessions: 6,  trend:  0, compat: 83 },
  { id: 'mk-t34', name: 'Escalade Indoor',          universe: 'sports',    subCategoryId: 'escalade',      members: [M.anis, M.clement],  points: 602,  rating: 4.2, sessions: 14, trend:  6, compat: 91 },
  { id: 'mk-t35', name: 'Espagnol B2',              universe: 'education', subCategoryId: 'espagnol',      members: [M.ines, M.amara],    points: 578,  rating: 3.8, sessions: 9,  trend: -3, compat: 66 },
  { id: 'mk-t36', name: 'DJ & Prod',                universe: 'music',     subCategoryId: 'dj',            members: [M.noah, M.maxime],   points: 555,  rating: 4.1, sessions: 5,  trend:  1, compat: 70 },
  { id: 'mk-t37', name: 'Photo & Lightroom',        universe: 'hobbies',   subCategoryId: 'photo',         members: [M.sasha, M.kim],     points: 530,  rating: 4.6, sessions: 8,  trend: -1, compat: 85 },
  { id: 'mk-t38', name: 'Diablo IV Grind',          universe: 'gaming',    subCategoryId: 'diablo',        members: [M.karim, M.remi],    points: 505,  rating: 3.4, sessions: 16, trend:  0, compat: 79 },
  { id: 'mk-t39', name: 'Boxe Thai & Sparring',     universe: 'sports',    subCategoryId: 'boxe',          members: [M.youssef, M.jad],   points: 482,  rating: 3.9, sessions: 12, trend:  4, compat: 87 },
  { id: 'mk-t40', name: 'Ukulélé Débutant',         universe: 'music',     subCategoryId: 'ukulele',       members: [M.leonie, M.camille],points: 460,  rating: 4.2, sessions: 3,  trend: -2, compat: 61 },
  { id: 'mk-t41', name: 'Marketing Digital',        universe: 'education', subCategoryId: 'marketing',     members: [M.sara, M.elisa],    points: 438,  rating: 4.0, sessions: 7,  trend:  1, compat: 73 },
  { id: 'mk-t42', name: 'Jardinage Urbain',         universe: 'hobbies',   subCategoryId: 'jardin',        members: [M.fatou, M.talia],   points: 415,  rating: 3.6, sessions: 5,  trend: -7, compat: 42 },
  { id: 'mk-t43', name: 'Halo Infinite Co-op',      universe: 'gaming',    subCategoryId: 'halo',          members: [M.tom, M.paul],      points: 392,  rating: 3.3, sessions: 10, trend:  0, compat: 76 },
  { id: 'mk-t44', name: 'Vélo & Gravel',            universe: 'sports',    subCategoryId: 'cyclisme',      members: [M.romain, M.basile], points: 368,  rating: 4.4, sessions: 8,  trend:  3, compat: 89 },
  { id: 'mk-t45', name: 'Podcast Culture Générale', universe: 'hobbies',   subCategoryId: 'podcast',       members: [M.amara, M.nora],    points: 345,  rating: 4.1, sessions: 6,  trend: -1, compat: 67 },
  { id: 'mk-t46', name: 'Basse Électrique',         universe: 'music',     subCategoryId: 'basse',         members: [M.hugo, M.theo],     points: 320,  rating: 3.8, sessions: 4,  trend:  2, compat: 74 },
  { id: 'mk-t47', name: 'Minecraft Build',          universe: 'gaming',    subCategoryId: 'minecraft',     members: [M.clara, M.jade],    points: 298,  rating: 3.5, sessions: 9,  trend: -3, compat: 83 },
  { id: 'mk-t48', name: 'Zumba & Cardio',           universe: 'sports',    subCategoryId: 'zumba',         members: [M.mia, M.salma],     points: 275,  rating: 4.0, sessions: 5,  trend:  0, compat: 71 },
  { id: 'mk-t49', name: 'Histoire de l\'Art',       universe: 'education', subCategoryId: 'histoire',      members: [M.lucie, M.chloe],   points: 150,  rating: 4.3, sessions: 2,  trend:  1, compat: 68 },
  { id: 'mk-t50', name: 'Jumelo Test',              universe: 'gaming',    subCategoryId: 'valorant',      members: [M.lea, M.axel],      points: 0,    rating: 0,   sessions: 0,  trend:  0, compat: 50 },
];
