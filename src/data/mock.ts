...
export const leaProfile: UserProfile = {
  ...
  interests: ['Valorant', 'Apex Legends', 'Musculation', 'Football'],
  subCategoryIds: ['valorant', 'apex', 'muscu', 'football'],
...
export const mockUsers: UserProfile[] = [
  leaProfile,
  {
    ...
    universes: ['gaming', 'sports'],
    interests: ['Valorant', 'Counter-Strike 2', 'Musculation', 'Running'],
    subCategoryIds: ['valorant', 'cs2', 'muscu', 'running'],
    online: false,
    onboardingComplete: true,
  },
  {
  ...
  },
  {
    ...
    universes: ['gaming'],
    interests: ['Valorant', 'Apex Legends', 'Fortnite'],
    subCategoryIds: ['valorant', 'apex', 'fortnite'],
    platforms: ['pc'],
    level: 'avance',
  ...
  },
  {
    ...
    interests: ['Football', 'Musculation', 'Valorant', 'Running'],
    subCategoryIds: ['football', 'muscu', 'valorant', 'running'],
    platforms: ['pc', 'irl'],
    level: 'intermediaire',
